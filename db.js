...
let db = {
    testimonials: [
        ...
        { id: 3, author: 'Amanda Doodle', text: 'They really know how to make you sad.' },
        { id: 4, author: 'Arnold Doe', text: 'They really know how to make you drunk.' },
        { id: 5, author: 'Amanda Doin', text: 'They really know how to make you angry.' },
    ],
    concerts: [
    ...
    seats:
        [
            ...
            { id: 7, day: 1, seat: 13, client: 'Molier Lo Celso', email: 'moiler.lo.celso@example.com' },
        ]
};
